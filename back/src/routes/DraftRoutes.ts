...
router.get("/:id", verifyAccessToken, verifyUser, asyncHandler(DraftController.getDraft));
router.get("/", verifyAccessToken, verifyUser, asyncHandler(DraftController.getAllDrafts));
router.delete("/:id", verifyAccessToken, verifyUser, asyncHandler(DraftController.deleteDraft));
