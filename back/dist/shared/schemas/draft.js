...
export const colorSchema = z.object({
    colorCode: z
        .string()
        .regex(/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/, "Цвет должен быть в формате HEX (#RRGGBB или #RRGGBBAA)"),
...
const draftPublishBaseSchema = z.object({
    ...
    place: placeSchema.extend({
        ...
        link: z
            ...
            value.startsWith("https://www.google.com/maps/"), 'Ссылка на место проведения должна начинаться с "https://yandex.ru/maps/" или "https://www.google.com/maps/"'),
    }),
    colors: z.array(colorSchema).nullable().optional(),
