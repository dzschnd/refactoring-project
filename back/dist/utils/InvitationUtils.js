...
export const getInvitationDetails = async (invitationId, isPublished, client = prisma) => {
    ...
    const formattedPlace = invitation.place
        ...
        : null;
    const formattedPlanItems = invitation.planItems.length > 0
        ...
        : null;
    const formattedColors = invitation.invitationColors.length > 0
        ...
        : null;
    const questions = invitation.questions.length > 0
        ...
        : null;
    const formattedAnswers = invitation.answers.length > 0
