...
import { MadeBy } from "./sections/MadeBy";
import { MD_SCREEN_WIDTH, MIN_SCREEN_WIDTH } from "../../../constants";
import background from "../../../assets/images/templates/nezhnost/background.avif";
...
export const NezhnostInvitation: FC<TemplateProps> = ({
  firstPartnerName,
  secondPartnerName,
  coupleImage,
  eventDate,
  ...
  usePreviewScrollPosition({
    ...
    paddingTop: isMobile ? 34 * scaleFactor : 40 * scaleFactor,
    currentBlock: block,
    colors: colors,
    wishes: wishes,
    wishesRef: wishesRef,
  ...
  return (
    ...
    >
      ...
      >
        <div ref={namesRef}>
          <Names
            ...
            coupleImage={
              coupleImage
                ? coupleImage
                : defaultTemplateImages.nezhnostCoupleImage
            }
            eventDate={eventDate}
            isMobile={isMobile}
            scale={scale}
        ...
        <div ref={dateRef}>
          <EventDate eventDate={eventDate} isMobile={isMobile} scale={scale} />
        </div>
        <div ref={placeRef}>
          <Place
            placeImage={
              place.placeImage
                ? place.placeImage
                : defaultTemplateImages.nezhnostPlaceImage
            }
