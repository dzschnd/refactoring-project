  ...
  return (
    <div>
      ...
      >
        <div>
          <h2
            className="text-center font-nezhnost--primary font-normal leading-[1.2] text-grey-500"
            style={{ fontSize: scale(32), marginBottom: scale(30) }}
          >
            Анкета гостя
          </h2>
          <p
            className="text-center font-nezhnost--secondary font-light leading-[1.6] tracking-[-0.02em] text-grey-500"
            style={{ fontSize: scale(16), maxWidth: scale(330) }}
          >
            Пожалуйста, подтвердите своё присутствие на нашем торжестве до{" "}
            <span
              className={
                "font-nezhnost--secondary font-bold leading-[1.4] tracking-[-0.02em] text-[#7C8D9D]"
              }
            >
              {formattedDate}
            </span>
        ...
        >
          <div className="relative flex flex-col" style={{ gap: scale(20) }}>
            <label
              htmlFor="names-input"
              className="font-nezhnost--secondary font-semibold leading-[1.4] tracking-[-0.02em] text-grey-500"
              style={{ fontSize: scale(16) }}
            >
              Имя и Фамилия
            </label>
            <p
              className="font-nezhnost--secondary font-light leading-[1.6] tracking-[-0.02em] text-grey-500"
              style={{ fontSize: scale(16) }}
            >
            ...
            <input
              ...
              className="border-b-[1px] border-b-grey-100 bg-beige bg-transparent font-nezhnost--secondary font-light leading-[1.4] tracking-[-0.02em] placeholder:text-grey-200 focus:outline-none"
              style={{ fontSize: scale(16) }}
            ...
            <div className="flex flex-col" style={{ gap: scale(10) }}>
              <div className="flex items-center">
                ...
                <label
                  ...
                  className="cursor-pointer font-nezhnost--secondary font-light leading-[1.6] tracking-[-0.02em] text-grey-500"
            ...
            [...questions]
              ...
              .map((question) => (
                <div
                  ...
                  className="relative flex flex-col gap-5 font-nezhnost--secondary"
                  style={{ gap: scale(20) }}
                >
                  <label
                    htmlFor={`question-${question.position}`}
                    className="whitespace-normal break-all font-semibold leading-[1.4] tracking-[-0.02] text-grey-500"
                    style={{ fontSize: scale(16) }}
                  >
                    {question.question}
                  </label>
                        ...
                        .map((answer) => (
                          ...
                          >
                            ...
                            <label
                              ...
                              className="cursor-pointer break-all font-nezhnost--secondary font-light leading-[1.6] tracking-[-0.02] text-grey-500"
                              style={{
