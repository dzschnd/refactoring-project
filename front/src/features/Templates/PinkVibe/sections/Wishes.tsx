...
export const Wishes: FC<TemplateWishesProps> = ({
  ...
  return (
    <div
      className={"flex min-w-full flex-col items-center bg-[#D2A69D]"}
      style={{
        gap: scale(20),
    ...
    >
      ...
      <div className={"flex"}>
        ...
        {wishes?.map((item, index) => (
          <p
            key={index}
            className={clsx(
              "break-all text-center font-nezhnost--secondary font-semibold leading-[1.4] tracking-[-0.02em] text-white",
      ...
      <div className={"flex items-center"} style={{ gap: scale(16) }}>
        ...
        <div
          className={
            "flex [&>*]:font-nezhnost--secondary [&>*]:font-semibold [&>*]:leading-[1.4] [&>*]:tracking-[-0.02] [&>*]:text-white"
          }
