...
import { MinimalismInvitation } from "./MinimalismInvitation";
import useCurrentDimensions from "../../../hooks/useCurrentDimensions";

export const MinimalismTemplate: FC = () => {
  ...
  const displayedColors = [
    ...
    { colorCode: "#F2F4F5", position: 1 },
    { colorCode: "#ACACAD", position: 2 },
    { colorCode: "#848484", position: 3 },
  ];
